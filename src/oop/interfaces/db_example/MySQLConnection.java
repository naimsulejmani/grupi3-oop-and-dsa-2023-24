...
public class MySQLConnection implements DbConnection{
    ...
    private final int SQL_PORT = 3306;
    ...
    public MySQLConnection(String connectionString) throws SQLException {
    ...
    public void connect() throws SQLException {
        System.out.println("Connecting to MySQL server... DB -> " + connectionString.getDatabase());
    }

    @Override
    public void disconnect() throws SQLException {
        System.out.println("Disconnect from MySQL server... DB -> " + connectionString.getDatabase());
    }
    ...
    public void close() throws Exception {
        System.out.println("Closing MySQL server...");
    }
}
